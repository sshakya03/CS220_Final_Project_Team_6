...
void  rmaPropagate0_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_t0_simv_netlist_daidir (UB  * pcode, UB  val);
void  rmaPropagate1_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_t0_simv_netlist_daidir (UB  * pcode, UB  val);
void  rmaPropagate2_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_t0_simv_netlist_daidir (UB  * pcode, UB  val);
void  rmaPropagate3_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate11_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate12_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_t0_simv_netlist_daidir (UB  * pcode, UB  val);
void  rmaPropagate14_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_p_simv_netlist_daidir (UB  * pcode, vec32  * I1128, U  I999);
void  rmaPropagate15_simv_netlist_daidir (UB  * pcode, vec32  * I1128, U  I999);
void  rmaPropagate15_t0_simv_netlist_daidir (UB  * pcode, U  I999);
void  rmaPropagate16_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate17_p_simv_netlist_daidir (UB  * pcode, vec32  * I1128, U  I999);
void  rmaPropagate17_simv_netlist_daidir (UB  * pcode, vec32  * I1128, U  I999);
void  rmaPropagate17_lbs_simv_netlist_daidir (UB  * pcode, scalar  val, U  I1159);
void  rmaPropagate17_lps_simv_netlist_daidir (UB  * pcode, vec32  * I1553, U  I1159, U  I1563);
void  rmaPropagate17_s0f_simv_netlist_daidir (UB  * pcode, vec32  * I1128);
void  rmaPropagate18_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate19_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate20_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate21_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate22_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate23_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate24_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate25_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate26_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate27_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate28_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate29_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate30_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate31_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate32_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate33_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate34_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate35_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate36_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate37_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate38_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate39_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate40_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate41_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate42_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate43_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate44_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate45_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate46_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate47_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate48_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate49_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate50_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate51_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate52_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate53_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate54_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate55_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate56_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate57_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate58_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate59_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate60_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate61_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate62_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate63_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate64_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate65_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate66_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate67_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate68_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate69_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate70_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate71_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate72_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate73_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate74_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate75_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate76_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate77_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate78_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate79_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate80_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate81_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate82_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate83_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate84_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate85_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate86_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate87_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate88_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate89_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate90_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate91_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate92_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate93_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate93_t0_simv_netlist_daidir (UB  * pcode, UB  val);
void  rmaPropagate93_s0_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate94_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate94_t0_simv_netlist_daidir (UB  * pcode, UB  val);
void  rmaPropagate94_s0_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate95_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate96_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate96_t0_simv_netlist_daidir (UB  * pcode, UB  val);
void  rmaPropagate97_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate97_t0_simv_netlist_daidir (UB  * pcode, UB  val);
void  rmaPropagate98_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate98_t0_simv_netlist_daidir (UB  * pcode, UB  val);
void  rmaPropagate99_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate99_t0_simv_netlist_daidir (UB  * pcode, UB  val);
void  rmaPropagate100_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate100_t0_simv_netlist_daidir (UB  * pcode, UB  val);
void  rmaPropagate100_s0_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate101_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate102_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate103_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate104_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate105_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate106_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate107_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate108_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate109_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate110_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate111_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate112_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate112_t0_simv_netlist_daidir (UB  * pcode, UB  val);
void  rmaPropagate112_s0_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate113_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate114_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate115_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate116_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate116_t0_simv_netlist_daidir (UB  * pcode, UB  val);
void  rmaPropagate116_s0_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate117_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate118_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate119_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate120_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate121_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate122_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate123_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate124_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate125_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate126_simv_netlist_daidir (UB  * pcode, scalar  val);
void  rmaPropagate127_simv_netlist_daidir (UB  * pcode, scalar  val);
